...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder", type=str, default="E:\车流\Pytorch-yolov3-vedio-master\Pytorch-yolov3-vedio-master\data\samples", help="path to dataset")
    parser.add_argument("--vedio_file", type=str, default="E:\车流/vehicle.mp4",help="path to dataset")
    parser.add_argument("--model_def", type=str, default="E:\车流\Pytorch-yolov3-vedio-master\Pytorch-yolov3-vedio-master\config/yolov3.cfg", help="path to model definition file")
    parser.add_argument("--weights_path", type=str, default="E:\车流\Pytorch-yolov3-vedio-master\Pytorch-yolov3-vedio-master\weights/yolov3.weights", help="path to weights file")
    parser.add_argument("--class_path", type=str, default="E:\车流\Pytorch-yolov3-vedio-master\Pytorch-yolov3-vedio-master\data/ptsc.names", help="path to class label file")
